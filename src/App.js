/**
 * App.js — Updated to wrap the entire tree with LanguageProvider.
 * Every other import and route stays exactly the same.
 */
...
import Products       from './pages/Products';          // ← updated (translation-aware)
...
export default function App() {
  return (
    <LanguageProvider>          {/* ← wraps everything so any component can useLang() */}
      <AuthProvider>
        <BrowserRouter>
          <AppRoutes />
        </BrowserRouter>
